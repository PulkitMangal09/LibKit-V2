    ...
    <nav class="navbar navbar-default" style="background-color: #7FC7D9; padding: 0px; height: 60px;">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li>
            <div class="btn-group">
              <button class="btn btn-outline  navbar-btn" @click="navigateTo('UserDash')" style="border-radius: 5px; height: 50px;">All Books</button>
              <button class="btn navbar-btn" @click="navigateTo('MyBooks')" style="border-radius: 5px; height: 50px; background-color: #3887BE; margin-right: 30px; color: white; ">My Books</button>
